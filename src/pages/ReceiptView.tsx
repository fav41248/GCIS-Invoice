...
export default function ReceiptView() {
  ...
  return (
    <div className='flex flex-col h-full overflow-hidden'>
      ...
      <div className='flex-1 overflow-auto bg-[#F8F9FA] p-8 flex justify-center print:p-0 print:bg-white'>
        <div id="receipt-preview" className='bg-white max-w-4xl w-full p-12 shadow-xl border border-gray-200 relative print:shadow-none print:border-none print:p-0'>
